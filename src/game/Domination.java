				...
				if(joueur == 1 )
				{
					...
					if(input.isMousePressed(0)) {
						if(xpos>800 && xpos<950 &&ypos<100 && ypos>40) {
							...
							tour=2;
							System.out.println("defosse 1 "+CompteurTour);
					...
					if(tour==0) {
						...
						if(input.isMousePressed(0)) {
							if(xpos>800 && xpos<950 &&ypos<100 && ypos>40) {
								CompteurTour=CompteurTour+2;
								tour=2;
								System.out.println("defosse 2 "+CompteurTour);
					...
					if(tour==0) {
						...
						if(input.isMousePressed(0)) {
							if(xpos>800 && xpos<950 &&ypos<100 && ypos>40) {
								CompteurTour=CompteurTour+2;
								tour=2;
								System.out.println("defosse 3 "+CompteurTour);
					...
					if(tour==0) {
						...
						if(input.isMousePressed(0)) {
							if(xpos>800 && xpos<950 &&ypos<100 && ypos>40) {
								CompteurTour=CompteurTour+2;
								tour=2;
								System.out.println("defosse 4 "+CompteurTour);
							}
					if(xpos>0 && xpos<windows.WIDTH/3 && ypos<windows.HEIGHT/3 && ypos>0 )
					{
...
//											bas.add(((windows.HEIGHT/27)*(26-b))-40);
		...
		if(joueur==4) {
			g.drawString("Tour du joueur :  1", windows.WIDTH/2 , windows.HEIGHT/2);
		}
		else if(joueur==3) {
			g.drawString("Tour du joueur :  2", windows.WIDTH/2 , windows.HEIGHT/2);
		}
		else {
