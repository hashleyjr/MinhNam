...
//	a prendre minh nam, je crois que y a que ça

	public ArrayList<Integer> ordreRandom(){
		ArrayList<Integer> OrdreJoueur= new ArrayList<Integer>(Arrays.asList(1,2,3,4));
