				...
				if(choisir==1) {
					...
					if(input.isMousePressed(0)) {
						...
						if(xpos>700 && xpos<900 ) {
							...
							choisir=0;
							System.out.println("sominos 4");
						}
					
						if(xpos>700 && xpos<900 && ypos<750 && ypos>780) {
							ChoixJ1 = Joueur.Choix(2, affich, AllDominos);
							choisir=0;
							System.out.println("sominos 3");

						
					}			
					
						if(xpos>700 && xpos<900 && ypos<650 && ypos>680) {
							ChoixJ1 = Joueur.Choix(1, affich, AllDominos);
							choisir=0;
							System.out.println("sominos 2");

						}
								
						if(xpos>700 && xpos<900 && ypos<550 && ypos>580) {
							ChoixJ1 = Joueur.Choix( 0, affich, AllDominos);
							choisir=0;
							System.out.println("Dominos 1");
									...
									System.out.println("possible : "+possible);
										if(!coordinates.contains(point) )
										{
											if(coordinates.size()==0 && possible.contains(point))
											{
												...
												g.drawString("okkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk",0,500);
