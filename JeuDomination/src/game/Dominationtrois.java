...
public class Dominationtrois extends BasicGameState {
	...
	*/
	...
	public Dominationtrois(int state) {
	...
	public void render(GameContainer gc, StateBasedGame sbg, Graphics g) throws SlickException {
		...
		g.drawString(ordre, windows.WIDTH/2 , windows.HEIGHT/2-50);
		g.drawString(resultat, windows.WIDTH/2 , windows.HEIGHT/2-30);
